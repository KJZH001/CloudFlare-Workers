...
async function handleRequest(request) 
{
    ...
    // 检查请求路径是否匹配
    // 旧版v3接口
    if(url.hostname === 'matrix-sticker.moeworld.top' && url.pathname.startsWith('/_matrix/media/v3/thumbnail/moeworld.top/')) 
    {
        // 修改路径和域名
    ...
    else if (url.hostname === 'matrix-sticker.moeworld.top' && url.pathname.startsWith('/_matrix/client/v1/media/thumbnail/moeworld.top/')) 
    {
        // 修改路径和域名
        const newHostname = 'matrix.moeworld.top';
